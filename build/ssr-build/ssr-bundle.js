...
var _lodash = __webpack_require__("wnaz");
...
// removed by extract-text-webpack-plugin
module.exports = {"home":"home__bLIH3"};
...
var embeddedJS = __webpack_require__("Azwd");
...
module.exports = {
     ...
     */
    render: function render(templateString, offerVariant, context) {
        // render all fields
...
var parse_url = __webpack_require__("Vy1O").parse;
var resolve_url = __webpack_require__("Vy1O").resolve;
...
var Body = __webpack_require__("ZiZz");
var Response = __webpack_require__("zyvZ");
var Headers = __webpack_require__("g7UK");
var Request = __webpack_require__("gz6R");
var FetchError = __webpack_require__("yH8B");
...
var utils = __webpack_require__("teMR");
...
var _OPTS = ['cache', 'filename', 'delimiter', 'context', 'debug', 'compileDebug', 'client', '_with', 'root', 'rmWhitespace', 'strict', 'localsName'];
...
module.exports = {
   ...
   * @public
   */
  render: function render(template, d, o) {
    var data = d || {};
    var options = o || {};
...
var realFetch = __webpack_require__("6hGK");
...
module.exports = { "default": __webpack_require__("ZHNR"), __esModule: true };
...
var dist = __webpack_require__("F5z4");
...
var header_Header = function (_Component) {
	...
	Header.prototype.renderToolbarSelect = function renderToolbarSelect(label, setAction, selectedItemIndex, items) {
		if (selectedItemIndex !== null) {
			return Object(preact_min["h"])(
				'div',
				{ 'class': header_style_default.a.selectWithLabelAbove },
				Object(preact_min["h"])(
					'div',
					{ 'class': header_style_default.a.selectLabel },
					label
				),
				Object(preact_min["h"])(
					preact_material_components_Select,
					{
						...
						onChange: function onChange(e) {
							return setAction(e.selectedIndex);
						},
						style: { width: "300px" }
					},
	...
	Header.prototype.render = function render() {
		...
		var _props = this.props,
		    ...
		    searchResultsURL = _props.searchResultsURL;
			...
			Object(preact_min["h"])(
				...
				Object(preact_min["h"])(
					...
					Object(preact_min["h"])(
						preact_material_components_Toolbar.Section,
						null,
						[this.renderToolbarSelect("Account", actions.setAccountAction, context.accountIndex, context.accounts), this.renderToolbarSelect("Environment", actions.setEnvironmentAction, context.environmentIndex, context.environments), this.renderToolbarSelect("Table", actions.setTableAction, context.tableIndex, context.tables)]
					),
					Object(preact_min["h"])(
						preact_material_components_Toolbar.Section,
					...
					Object(preact_min["h"])(
						...
						Object(preact_min["h"])(
							...
							{ onClick: function onClick() {
									route(searchResultsURL);_this2.closeDrawer();
								} },
							_ref3,
							'List'
						),
						...
						Object(preact_min["h"])(
							preact_material_components_List.LinkItem,
							{ onClick: function onClick() {
									document.location = "http://admin.persoo.cz";_this2.closeDrawer();
								} },
							_ref5,
							'Administration'
						)
...
// CONCATENATED MODULE: ./cloudConfig.js


/* harmony default export */ var cloudConfig = ({
    clouds: {
        'production': {
...
// CONCATENATED MODULE: ./components/persooClient/index.js
function persooClient__classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function persooClient__possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return call && (typeof call === "object" || typeof call === "function") ? call : self; }

function persooClient__inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }
...
var persooClient_PersooClient = function (_Component) {
    persooClient__inherits(PersooClient, _Component);

    function PersooClient(props) {
        persooClient__classCallCheck(this, PersooClient);

        var _this = persooClient__possibleConstructorReturn(this, _Component.call(this, props));
    ...
    PersooClient.prototype._initPersooClient = function _initPersooClient(cloudID, accountID) {
        window.persooConfig = {
        ...
        var persooLoader = function (a, b, c, d, e) {
            var f = d.persooName,
                g = '_persoo_hide_body';return { hideBody: function hideBody() {
                    var b = a.createElement('style'),
                        c = 'body{opacity:0 !important;filter:alpha(opacity=0)' + ' !important;background:none !important;}',
                        d = a.getElementsByTagName('head')[0];b.setAttribute('id', g), b.setAttribute('type', 'text/css'), b.styleSheet ? b.styleSheet.cssText = c : b.appendChild(a.createTextNode(c)), d.appendChild(b);
                }, finish: function finish() {
                    if (!c) {
                        c = !0;var b = a.getElementById(g);b && b.parentNode.removeChild(b);
                    }
                }, loadScript: function loadScript(b) {
                    var c = a.createElement('script');c.src = b, c.type = 'text/javascript', c.onerror = function () {
                        persooLoader.finish();
                    }, a.getElementsByTagName('head')[0].appendChild(c);
                }, init: function init() {
                    b[f] = b[f] || function () {
                        (b[f].q = b[f].q || []).push([].slice.call(arguments));
                    }, b[f].l = 1 * new Date(), b[f].apikey = d.apikey, b[f].dataLayerName = d.dataLayerName;var c = a.cookie.match('(^|; )' + e + '=([^;]*)'),
                        g = location.search.match('[?&]' + e + '=([^&]*)'),
                        h = g ? g[1] : c ? c[2] : 'p';d.settings_tolerance > 0 && (setTimeout(this.finish, d.settings_tolerance), this.hideBody());var i = (d.scriptsHostname || 'http://scripts.persoo.cz/') + d.apikey + '/' + h;this.loadScript(i + '/actions.js'), this.loadScript(i + '/persoo.js');
                } };
        }(document, window, !1, persooConfig, 'persooEnvironment');persooLoader.init();
    };

    PersooClient.prototype.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
    ...
    PersooClient.prototype.render = function render(props) {
        return null;
    };
...
var login__ref2 = Object(preact_min["h"])(
	...
	Object(preact_min["h"])(
		...
		Object(preact_min["h"])(
			...
			Object(preact_min["h"])(
				'a',
				{ href: 'https://adminapi-test-a.persoo.cz' },
				'Login'
			)
		)
	)
...
var login_Login = function (_Component) {
	...
	Login.prototype.render = function render() {
		return Object(preact_min["h"])(
			'div',
			{ 'class': login_style_default.a.home },
			login__ref,
			login__ref2
		);
	};
...
// EXTERNAL MODULE: ./routes/searchResults/style.css
var searchResults_style = __webpack_require__("1EUC");
var searchResults_style_default = /*#__PURE__*/__webpack_require__.n(searchResults_style);

// EXTERNAL MODULE: ./components/persooSearchResults/style.css
var persooSearchResults_style = __webpack_require__("zERu");
var persooSearchResults_style_default = /*#__PURE__*/__webpack_require__.n(persooSearchResults_style);

// EXTERNAL MODULE: ../node_modules/persoo-templates/lib/embeddedjs.js
var embeddedjs = __webpack_require__("Azwd");
var embeddedjs_default = /*#__PURE__*/__webpack_require__.n(embeddedjs);

// EXTERNAL MODULE: ../node_modules/persoo-templates/lib/index.js
var lib = __webpack_require__("2mdM");
...
// CONCATENATED MODULE: ./utils/templateComponentsUtils.js
var templateComponentsUtils__extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };



function templateComponentsUtils__classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function templateComponentsUtils__possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return call && (typeof call === "object" || typeof call === "function") ? call : self; }

function templateComponentsUtils__inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }
 ...
 */
function templateComponentsUtils_convertToReactComponent(template) {
    var renderTemplateFunction = template;
    if (typeof template == 'string') {
        if (template.indexOf('%>') >= 0) {
            ...
            renderTemplateFunction = embeddedjs_default.a.compile(template, ejsOptions);
        } else {
            // plain string
            renderTemplateFunction = function renderTemplateFunction() {
                return template;
            };
        }
    }
    ...
    var TemplateComponent = function (_AbstractCustomTempla) {
        templateComponentsUtils__inherits(TemplateComponent, _AbstractCustomTempla);

        function TemplateComponent(props) {
            templateComponentsUtils__classCallCheck(this, TemplateComponent);

            return templateComponentsUtils__possibleConstructorReturn(this, _AbstractCustomTempla.call(this, renderTemplateFunction, props));
        }

        return TemplateComponent;
    }(templateComponentsUtils_AbstractCustomTemplate);
    return TemplateComponent;
}

var templateComponentsUtils_AbstractCustomTemplate = function (_PureComponent) {
    templateComponentsUtils__inherits(AbstractCustomTemplate, _PureComponent);

    function AbstractCustomTemplate(renderTemplateFunction, props) {
        templateComponentsUtils__classCallCheck(this, AbstractCustomTemplate);

        var _this2 = templateComponentsUtils__possibleConstructorReturn(this, _PureComponent.call(this, props));

        _this2.renderTemplateFunction = renderTemplateFunction;
        return _this2;
    }

    AbstractCustomTemplate.prototype.render = function render(props) {
        ...
        var rawHTML = this.renderTemplateFunction(props);
        if (rawHTML) {
            return Object(preact_min["h"])('div', templateComponentsUtils__extends({
                dangerouslySetInnerHTML: { __html: rawHTML }
            }, { className: className, style: style, onMouseEnter: onMouseEnter, onMouseDown: onMouseDown, onMouseLeave: onMouseLeave }));
        } else {
            return null;
        }
    };

    return AbstractCustomTemplate;
}(PureComponent);
...
// CONCATENATED MODULE: ./components/persooSearchResults/index.js


function persooSearchResults__classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function persooSearchResults__possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return call && (typeof call === "object" || typeof call === "function") ? call : self; }

function persooSearchResults__inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }
...
var persooSearchResults__ref = Object(preact_min["h"])(
    'h1',
    null,
    'Search Results'
);

var persooSearchResults_SearchResults = function (_Component) {
    persooSearchResults__inherits(SearchResults, _Component);

    function SearchResults() {
        persooSearchResults__classCallCheck(this, SearchResults);

        return persooSearchResults__possibleConstructorReturn(this, _Component.apply(this, arguments));
    }

    SearchResults.prototype.createDefaultContentFromTemplate = function createDefaultContentFromTemplate(template) {
        var offer = {
            variants: [{
    ...
    SearchResults.prototype.getSearchResultsHTML = function getSearchResultsHTML(searchResultsOfferTemplate) {
        var offer = this.createDefaultContentFromTemplate(searchResultsOfferTemplate);
        var offerContext = {
        ...
        return lib_default.a.render(searchResultsOfferTemplate.template, offer.variants[0], offerContext);
    };

    SearchResults.prototype.runJavascriptInHTML = function runJavascriptInHTML() {
    ...
    SearchResults.prototype.render = function render(props) {
        console.log('Render Search Results');

        var searchResultsOfferTemplate = props.searchResultsOfferTemplate;

        var SearchComponent = null;
        if (searchResultsOfferTemplate) {
            SearchComponent = templateComponentsUtils_convertToReactComponent(this.getSearchResultsHTML.bind(this, searchResultsOfferTemplate));
            /* Notes:
        ...
        return Object(preact_min["h"])(
            'div',
            { 'class': persooSearchResults_style_default.a.home },
            persooSearchResults__ref,
            Object(preact_min["h"])(
                'pre',
                null,
                JSON.stringify(props, false, 4)
            ),
            Object(preact_min["h"])(SearchComponent, null)
        );
    };
...
// CONCATENATED MODULE: ./routes/searchResults/index.js
...
var searchResults__ref = Object(preact_min["h"])(
  'h1',
  null,
  'Search Results'
);
...
var searchResults_SearchResults = function (_Component) {
  ...
  SearchResults.prototype.render = function render(props) {
    ...
    var SearchComponent = null;
    if (searchResultsOfferTemplate) {
      SearchComponent = convertToReactComponent(this.getSearchResultsHTML.bind(this, searchResultsOfferTemplate));
      /* Notes:
            - <script> element se vlozi jako rawHTML, ale neozivi (tedy nicemu nevadi}
      */
    }
    ...
    return Object(preact_min["h"])(
      'div',
      { 'class': searchResults_style_default.a.home },
      searchResults__ref,
      Object(preact_min["h"])(
        'pre',
        null,
      ...
      Object(preact_min["h"])(persooSearchResults_SearchResults, props)
    );
  };
...
// EXTERNAL MODULE: ./routes/debug/style.css
var debug_style = __webpack_require__("q3Hd");
var debug_style_default = /*#__PURE__*/__webpack_require__.n(debug_style);

// CONCATENATED MODULE: ./routes/debug/index.js


function debug__classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function debug__possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return call && (typeof call === "object" || typeof call === "function") ? call : self; }

function debug__inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }




var debug_Debug = function (_Component) {
	debug__inherits(Debug, _Component);

	function Debug() {
		debug__classCallCheck(this, Debug);

		return debug__possibleConstructorReturn(this, _Component.apply(this, arguments));
	}

	Debug.prototype.render = function render(props) {
		return Object(preact_min["h"])(
			'div',
			{ 'class': debug_style_default.a.home },
			Object(preact_min["h"])(
				'h1',
				null,
				'We received pageType ',
				props.pageType
			),
			Object(preact_min["h"])(
				'pre',
...
// EXTERNAL MODULE: ./routes/redirect/style.css
var redirect_style = __webpack_require__("Z7+E");
var redirect_style_default = /*#__PURE__*/__webpack_require__.n(redirect_style);
...
var createStore__extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
function createStore(initialState) {
    ...
    return {
        ...
        updateState: function updateState(increment) {
            createStore__extends(state, increment);
            dispatch();
        },
...
// CONCATENATED MODULE: ./store/appStore.js
var appStore__extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
function getInitialState(options) {
    var state = {
        ...
        context: {
            ...
            environmentID: "p",
            environmentIndex: 0,
            environments: [{ id: "p", name: "production             ." }, { id: "test", name: "test             ." }],
...
function createAppStore(initialState) {
    ...
    return appStore__extends(store, {
        hasItems: function hasItems() {
            // in any dataset
            var hasItems = false;
            store.getState().datasets.forEach(function (dataset) {
...
// CONCATENATED MODULE: ./utils/urlUtils.js
function getSearchResultsURL(context) {
        var searchResultsURL = ['', context.accountID, context.environmentID, context.tableID, 'list'].map(function (a) {
                return a == null ? 'null' : a;
        }).join('/');
        return searchResultsURL;
}
// EXTERNAL MODULE: ../node_modules/json-fetch/lib/index.js
var json_fetch_lib = __webpack_require__("jb/Z");
var json_fetch_lib_default = /*#__PURE__*/__webpack_require__.n(json_fetch_lib);

// CONCATENATED MODULE: ./actions/appActions.js





function createAppActions(store) {
    ...
    function askForLogin() {
        ...
        preact_router_es_Router.route('/login');
    }
    function loadAccounts() {
        var cloudID = store.getState().context.cloudID;

        json_fetch_lib_default()(cloudConfig.clouds[cloudID].adminAPIEndpoint + '/accounts', {
            method: 'GET',
            // body: {},
    ...
    function loadMetaDataTables() {
        ...
        var cloudID = state.context.cloudID;
        ...
        json_fetch_lib_default()(cloudConfig.clouds[cloudID].adminAPIEndpoint + '/accounts/' + accountID + '/metadata?environment=' + envID, {
            method: 'GET',
            // body: {},
            expectedStatuses: [200]
        }).then(function (response) {
            ...
            context.tables = response.body.map(function (str) {
    ...
    function loadMetaDataVariableForTable() {
        ...
        json_fetch_lib_default()(cloudConfig.clouds[cloudID].adminAPIEndpoint + '/accounts/' + accountID + '/metadata/' + tableID + '/listVariables?environment=' + envID, {
            method: 'GET',
            // body: {},
            expectedStatuses: [200]
        }).then(function (response) {
    ...
    function loadSearchResultsWidgetTemplate() {
        ...
        json_fetch_lib_default()(cloudConfig.clouds[cloudID].adminAPIEndpoint + '/accounts/' + accountID + '/templates/searchResultsV1', {
            method: 'GET',
            // body: {},
            expectedStatuses: [200]
        }).then(function (response) {
    ...
    return {
        ...
        updateContextFromURL: function updateContextFromURL(accountID, environmentID, tableID) {
            var context = store.getState().context;
            if (context.accountID !== accountID || context.environmentID !== environmentID || context.tableID !== tableID) {
        ...
        setAccountAction: function setAccountAction(index) {
            var context = store.getState().context;
        ...
        setEnvironmentAction: function setEnvironmentAction(index) {
            var context = store.getState().context;
        ...
        setTableAction: function setTableAction(index) {
            var context = store.getState().context;
...
var app__ref2 = Object(preact_min["h"])(login_Login, { path: '/login' });
...
var app__ref5 = Object(preact_min["h"])(debug_Debug, { path: '/:accountID/:env/:adsTable/detail/:itemID?', pageType: 'detail' });
...
var app_App = function (_Component) {
    ...
    function App(args) {
        ...
        var _this = app__possibleConstructorReturn(this, _Component.call(this, args));

        _this.handleRoute = function (e) {
            _this.currentUrl = e.url;
        };

        _this.store = createAppStore(getInitialState(args.options || {}));
        _this.unsubcribe = _this.store.subscribe(_this._updateLocalStateFromStore.bind(_this));
        _this.setState(_this.store.getState());

        // can be moved to on ComponentWillMount
        _this.actions = createAppActions(_this.store);

        /* main */
        _this.actions.loadAccounts();
        return _this;
    }

    App.prototype._updateLocalStateFromStore = function _updateLocalStateFromStore() {
    ...
    App.prototype.getProfile = function getProfile() {
    ...
    App.prototype.render = function render() {
        ...
        var searchResultsOfferTemplate = this.state.searchResultsOfferTemplate;
        var searchResultsURL = getSearchResultsURL(context);
        return Object(preact_min["h"])(
            'div',
            { id: 'app' },
            Object(preact_min["h"])(persooClient_PersooClient, { context: context }),
            context.accountsLoaded && Object(preact_min["h"])(header_Header, {
                context: context,
            ...
            Object(preact_min["h"])(
                ...
                Object(preact_min["h"])(redirect_Redirect, { path: '/', to: searchResultsURL }),
                app__ref2,
                app__ref3,
                app__ref4,
                app__ref5,
                ...
                Object(preact_min["h"])(searchResults_SearchResults, { path: '/:accountID/:env/:adsTable/list', pageType: 'list',
                    searchResultsOfferTemplate: searchResultsOfferTemplate
                }),
                Object(preact_min["h"])(debug_Debug, { 'default': true, pageType: '404',
...
// removed by extract-text-webpack-plugin
module.exports = {"home":"home__10m3k"};
...
var errcode = __webpack_require__("hJiz");
var retry = __webpack_require__("yi9p");
...
// removed by extract-text-webpack-plugin
module.exports = {"home":"home__2x9qK"};
...
var convert = __webpack_require__("86Pa").convert;
var bodyStream = __webpack_require__("u9AE");
var PassThrough = __webpack_require__("97RM").PassThrough;
var FetchError = __webpack_require__("yH8B");
...
__webpack_require__("Ut/h")(IteratorPrototype, __webpack_require__("+PgN")('iterator'), function () {
  return this;
});
...
var _asyncToGenerator2 = __webpack_require__("kcQR");
...
var _retriers = __webpack_require__("9ZFr");
...
__webpack_require__("HoOA");

var _promiseRetry = __webpack_require__("UrEo");

var _promiseRetry2 = _interopRequireDefault(_promiseRetry);

var _get_request_options = __webpack_require__("+UUS");
...
// removed by extract-text-webpack-plugin
module.exports = {"home":"home__bex78"};
...
module.exports = {
   ...
   * @private
   */
  escapeRegExpChars: function escapeRegExpChars(string) {
    // istanbul ignore if
    if (!string) {
      return '';
    }
   ...
   * @private
   */
  shallowCopy: function shallowCopy(to, from) {
    from = from || {};
    for (var p in from) {
      to[p] = from[p];
    }
...
var RetryOperation = __webpack_require__("nMzr");
...
// removed by extract-text-webpack-plugin
module.exports = {"selectWithLabelAbove":"selectWithLabelAbove__3n8XA","selectLabel":"selectLabel__tixU4"};
...
module.exports = !__webpack_require__("EPcB") && !__webpack_require__("w113")(function () {
  return Object.defineProperty(__webpack_require__("JWjT")('div'), 'a', { get: function get() {
      return 7;
    } }).a != 7;
});
...
__webpack_require__("Bcfi").inherits(FetchError, Error);
...
module.exports = __webpack_require__("tprn");
...
// removed by extract-text-webpack-plugin
module.exports = {"home":"home__1V5to"};
